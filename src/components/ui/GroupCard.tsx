...
const GroupCard = ({ group }: GroupCardProps) => {
  ...
  const getColorClasses = (color: string) => {
    const colorMap = {
      green:
        'border-medical-green/20 bg-medical-green-light/10 hover:bg-medical-green-light/20',
      ...
      purple:
        'border-medical-purple/20 bg-medical-purple-light/10 hover:bg-medical-purple-light/20',
  ...
  return (
    <Card
      className={`mb-4 transition-all duration-200 cursor-pointer ${getColorClasses(group.color)}`}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button size="sm" variant="outline" className="h-8">
              ...
              {t('groupCard.Profile.points.glucoseSharing.joinButton')}
            </Button>
          </div>
        </div>
      </CardContent>
