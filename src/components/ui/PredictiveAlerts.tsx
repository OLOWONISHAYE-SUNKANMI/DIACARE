...
import { AlertTriangle, Clock, TrendingDown, TrendingUp, Shield, Pill, Target, Brain, X, CheckCircle } from 'lucide-react';
      ...
      <Card className={`bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200 ${className}`}>
        <CardContent className="p-6">
          <div className="flex items-center justify-center space-x-3">
            ...
            <div>
              <p className="text-lg font-semibold text-blue-700">Analyse IA en cours...</p>
              <p className="text-sm text-blue-600">Détection des patterns glycémiques</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      {activeAlerts.length === 0 ? (
        ...
        <div className="space-y-3">
          {activeAlerts.map((alert) => (
            <Card key={alert.id} className="border-l-4 border-l-orange-500 shadow-lg">
              <CardHeader className="pb-3">
              ...
              <CardContent className="pt-0">
                ...
                <Alert className="mb-4 bg-blue-50 border-blue-200">
                  ...
                  <AlertDescription className="text-blue-700">
                    <strong>Prédiction :</strong> {alert.prediction}
                    {alert.timeframe < 999 && (
