        ...
        <div className="space-y-2 sm:space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex items-baseline justify-center gap-2 flex-wrap">
              <span className="text-4xl sm:text-5xl lg:text-6xl font-bold text-medical-green">{currentGlucose}</span>
              <span className="text-sm sm:text-lg text-muted-foreground">mg/dL</span>
