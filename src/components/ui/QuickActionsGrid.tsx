...
const QuickActionsGrid = ({ onActionPress }: QuickActionsGridProps) => {
  ...
  const quickActions: QuickAction[] = [
    {
      icon: BarChart3,
      label: t('quickActionsGrid.quickActions.glucose'),
      emoji: '🩸',
      action: 'glucose',
    ...
    {
      icon: Utensils,
      label: t('quickActionsGrid.quickActions.meal'),
      emoji: '🥗',
      action: 'meal',
    ...
    {
      icon: Pill,
      label: t('quickActionsGrid.quickActions.medication'),
      emoji: '💊',
      action: 'medication',
    ...
    {
      icon: Footprints,
      label: t('quickActionsGrid.quickActions.activity'),
      emoji: '🏃‍♂️',
      action: 'activity',
    ...
    {
      icon: Clock,
      label: t('quickActionsGrid.quickActions.reminders'),
      emoji: '⏰',
      action: 'reminders',
  ...
  return (
    <div className="px-4 space-y-4">
      <h3 className="text-lg font-semibold text-foreground">
        {t('quickActionsGrid.quickActions.title')}
      </h3>
          ...
          return (
            ...
            >
              <CardContent className="p-0">
                {/* Gradient header */}
                <div
                  className={`bg-gradient-to-br ${action.gradient} p-6 text-center relative overflow-hidden w-full`}
                >
