    ...
    <Card className="mb-6">
      <CardHeader className="pb-4">
        <CardTitle className="text-lg flex items-center">
          ...
          {t('countrySelector.Settings.countryCurrency.title')}
        </CardTitle>
      </CardHeader>
        ...
        {isDetecting ? (
          <div className="text-center py-4">
            ...
            <p className="text-sm text-muted-foreground">
              {t('countrySelector.Settings.countryCurrency.detecting')}
            </p>
          </div>
        ) : (
          <>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm font-medium text-blue-800">
                        {t('countrySelector.Settings.countryCurrency.detected')}
                        :{' '}
                        {
                          CurrencyConverter.getCurrencyInfo(detectedCountry)
                            .country
                        }
                      </span>
                    </div>
                    ...
                    >
                      {t('countrySelector.Settings.countryCurrency.use')}
                    </Button>
                  </div>
                </div>
              )}
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-green-800">
                      {
                        CurrencyConverter.getCurrencyInfo(selectedCountry)
                          .country
                      }
                    </p>
