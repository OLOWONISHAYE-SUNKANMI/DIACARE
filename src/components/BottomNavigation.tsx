...
const BottomNavigation: React.FC<BottomNavigationProps> = ({
  ...
  const colorVariants = {
    teal: { base: "text-teal-500", active: "bg-teal-100 text-teal-700", hover: "hover:bg-teal-50" },
    coral: { base: "text-rose-500", active: "bg-rose-100 text-rose-600", hover: "hover:bg-rose-50" },
    orange: { base: "text-orange-500", active: "bg-orange-100 text-orange-600", hover: "hover:bg-orange-50" },
    green: { base: "text-green-700", active: "bg-green-100 text-green-800", hover: "hover:bg-green-50" },
  };
